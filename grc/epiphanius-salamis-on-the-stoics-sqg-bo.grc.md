---
title: On the Stoics (from On Faith)
title_greek: Περὶ τῶν Στωϊκῶν
...
# On the Stoics (from On Faith)

*Περὶ τῶν Στωϊκῶν*

**Author:** Epiphanius of Salamis

**eul_wid:** `sqg-bo` · [HTML page](https://eulogikon.org/works/epiphanius-salamis-on-the-stoics-sqg-bo)
...
Eulogikon publishes public-domain Greek texts in cleaned, structured, readable form and makes no copyright claim over that preparation (Public Domain Mark 1.0, https://creativecommons.org/publicdomain/mark/1.0/). Cite as `eul_wid: sqg-bo`.
