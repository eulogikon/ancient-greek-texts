...
**eul_wid:** `bww-ci` · [HTML page](https://eulogikon.org/works/hippocrates-epidemics-2-bww-ci)
...
Eulogikon publishes public-domain Greek texts in cleaned, structured, readable form and makes no copyright claim over that preparation (Public Domain Mark 1.0, https://creativecommons.org/publicdomain/mark/1.0/). Cite as `eul_wid: bww-ci`.
