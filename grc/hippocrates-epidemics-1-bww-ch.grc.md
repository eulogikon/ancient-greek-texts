...
eul_wid: bww-ch
eul_aid: bww
canonical: "https://eulogikon.org/works/hippocrates-epidemics-1-bww-ch"
period: Classical
dialect: Ionic
domain: Medicine
format: Treatise
...
**eul_wid:** `bww-ch` · [HTML page](https://eulogikon.org/works/hippocrates-epidemics-1-bww-ch)
...
Eulogikon publishes public-domain Greek texts in cleaned, structured, readable form and makes no copyright claim over that preparation (Public Domain Mark 1.0, https://creativecommons.org/publicdomain/mark/1.0/). Cite as `eul_wid: bww-ch`.
