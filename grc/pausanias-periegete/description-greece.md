...
title_greek: Ἑλλάδος Περιηγήσεως
author: Pausanias Periegete
eul_wid: qvs-aa
eul_aid: qvs
canonical: "https://eulogikon.org/grc/pausanias-periegete/description-greece"
period: Roman
dialect: Koine
domain: Geography
format: Prose
...
**eul_wid:** `qvs-aa` · [HTML page](https://eulogikon.org/grc/pausanias-periegete/description-greece)
...
Eulogikon publishes public-domain Greek texts in cleaned, structured, readable form and makes no copyright claim over that preparation (Public Domain Mark 1.0, https://creativecommons.org/publicdomain/mark/1.0/). Cite as `eul_wid: qvs-aa`.
